...
![文件類型](https://img.shields.io/badge/文件類型-標準文件-blue)
...
```
7.2.Web_Warehousing/
├── docs/                     # 專案文件集中存放目錄（所有非程式碼文件）
│   ├── 0.standards/          # 標準文件：專案憲章、總規範、SDD 工作流程
│   │   ├── 0.專案憲章-總規範-SDD工作流程/
...
│   │   └── [模組名稱].review.md
│   ├── 5.otherDocs/          # 其他文件：初始化說明、會議記錄等
│   └── README.md             # docs 文件總覽與使用說明
...
**文件存放規範**：所有專案文件（除程式碼外）必須集中存放於 `docs/` 資料夾，詳見[docs 文件總覽](../../README.md)。
