...
**文件版本**: v1.0.0  
**建立日期**: 2025-11-28  
**依據**: `docs/0.standards/README徽章使用規範.md`
...
**注意**：所有文件（除程式碼外）必須集中存放於 `docs/` 資料夾（詳見專案憲章 P14.3 節）。
...
- README.md 必須遵循 `docs/0.standards/README徽章使用規範.md` 的格式規範
...
請遵循 `docs/0.standards/0.專案憲章-總規範-SDD工作流程/2.文件倉儲管理系統 Warehouse Management System 設計規範v2.0.md` 中的設計規範。
...
4. **檢查規範**：確保符合 `docs/0.standards/README徽章使用規範.md` 的要求。

---

**文件版本**: v1.0.0  
**參考文件**: `docs/0.standards/README徽章使用規範.md`
