...
| JOB_DESC | 工作描述 | job_description | job_desc |   | varchar(255) |  |  |  |  |  |
| OWNER | 擁有者 | owner | owner |   | varchar(40) |  |  |  |  |  |
...
| NEXT_DATE | 下次日期 | next_date | next_date |   | varchar(8) |  |  |  |  |  |
| NEXT_TIME | 下次時間 | next_time | next_time |   | varchar(6) |  |  |  |  |  |
| STATUS | 狀態 | status | status |   | varchar(1) |  |  |  |  |  |
| FINISH_DATETIME | 完成時間 | complete_time | finish_time |   | varchar(14) |  |  |  |  |  |
