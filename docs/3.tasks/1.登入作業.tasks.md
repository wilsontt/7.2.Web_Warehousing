...
**狀態**: 待執行 (Pending)
**建立日期**: 2025-11-27
**依據**: `docs/2.plans/1.登入作業.plan.md`

---

## 任務清單 (Task List)

- [x] **T-1-1-1: 建立 AuthContext** <!-- id: 12 -->
    - **目標**: 實作認證狀態管理邏輯。
...
- [x] **T-1-1-2: 建立 ProtectedRoute 組件** <!-- id: 13 -->
    - **目標**: 實作路由守衛。
