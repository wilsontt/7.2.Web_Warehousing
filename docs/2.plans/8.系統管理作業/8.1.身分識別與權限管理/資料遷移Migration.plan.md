...
**狀態**: 草稿 (Draft)
**建立日期**: 2026-01-01
**依據**: `docs/1.specs/8.系統管理作業/8.1.身分識別與權限管理/資料遷移Migration.spec.md`
...
| 原則 | 檢查項目 | 符合 | 說明 |
|:---|:---|:---:|:---|
| **P0: SDD 流程** | 是否有對應的 Spec 文件？ | ✅ | 已建立 `docs/1.specs/8.系統管理作業/8.1.身分識別與權限管理/資料遷移Migration.spec.md` |
...
- `docs/1.specs/8.系統管理作業/8.1.身分識別與權限管理/資料遷移Migration.spec.md`
- `docs/0.standards/4.資料庫結構分析/8.系統管理作業/1.身分識別與權限管理/USR_使用者主檔.md`
- `docs/0.standards/4.資料庫結構分析/1.基本作業/3.客戶資料維護/CMP_TABLE.md`
- `docs/0.standards/4.資料庫結構分析/8.系統管理作業/1.身分識別與權限管理/0.2.客戶資料維護與IAM整合設計總結.md`
- `docs/0.standards/4.資料庫結構分析/8.系統管理作業/1.身分識別與權限管理/0.身分識別與帳號整合策略.md`
